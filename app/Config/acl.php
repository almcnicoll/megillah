<?php
	 ...
	 * that is not allowed by default (e.g. via $this->Auth->allow('edit') in the Invoices controller) then
	 * AuthComponent will ask the configured ACL interface if access is granted. Under the assumptions 1. and 2. this
	 * will be done via a call to Acl->check() with
	 * {{{
