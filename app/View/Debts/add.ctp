	...
	<div class="col-md-10 col-md-push-2">
		...
		<fieldset>
			...
			<div class="row">
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<?php echo $this->Form->input( 'amount',
									array( 'min' => 0, 'step' => 0.001, 'value' => '0.00', 'formnovalidate' => '' ) ); ?>
							</div>
						</div>
					</div>
					<div
				...
				<div class="col-lg-6">
					<?php if ( empty( $this->params['named']['priority'] ) ): ?>
						<div
					...
					<div id="offer-container">
						<div
							...
							<div class="col-sm-9">
								<div class="input-group">
									<span class="input-group-addon">&pound;</span>
									<?php echo $this->Form->input( 'offer', array(
										'min'   => 0,
										'step'  => 0.01,
										'value' => '0.00'
									) ); ?>
						...
						<div
							...
							<div class="col-sm-9">
								<?php echo $this->Form->input( 'offer_frequency',
									array( 'options' => Debt::frequencies(), 'value' => Debt::FREQUENCY_MONTHLY ) ); ?>
							</div>
						</div>
					</div>
					<div
...
<?php
$getCreditorURL = $this->Html->url( array( 'controller' => 'creditors', 'action' => 'details', 'ext' => 'json' ), true );
