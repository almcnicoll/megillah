...
<div class="row">
	<div class="col-md-10 col-md-push-2">
		<?php echo $this->Form->create( 'FinanceCategory', array(
			...
			<div class="row">
				<div class="col-lg-6">
					...
					<div class="form-group <?php echo ( $this->Form->error( 'type' ) !== null ) ? 'has-error' : ''; ?>">
						<?php echo $this->Form->label( 'type', null, array( 'class' => 'col-sm-3 control-label' ) ); ?>
						<div class="col-sm-9">
							<?php echo $this->Form->input( 'type', array( 'options' => FinanceCategory::types() ) ); ?>
						</div>
					</div>
					<br/>
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-9">
							<button type="submit"
							        class="btn btn-primary btn-block btn-lg visible-xs visible-sm"><?php echo __( 'Save' ); ?></button>
							<button type="submit"
	...
	<div class="col-md-2 col-md-pull-10">
		<ul class="nav nav-pills nav-stacked">
			<li><?php echo $this->Form->postLink( __( 'Delete' ), array(
					'action' => 'delete',
					$this->Form->value( 'FinanceCategory.id' )
