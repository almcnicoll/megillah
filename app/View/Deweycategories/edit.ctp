...
<?php echo $this->Form->create('Deweycategory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Deweycategory'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Deweycategory.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Deweycategory.id'))); ?></li>
