 ...
 */
?>
<h2>Sorry - the database is temporarily unavailable</h2>
<p>This is most likely a temporary glitch. I'm afraid it's possible that data you entered on the previous screen may not have been saved.</p>
...
<?php
	error_log('Missing Connection exception');
