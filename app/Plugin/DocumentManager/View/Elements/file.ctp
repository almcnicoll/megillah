...
<div class="name-index file col-lg-6">
	<?php
	$name = $file['name'];
	/*
	...
	*/
	$direct_link = @Document::getRelativePath($pathFolderNames, $file['name']);
	$internal_link = array(
		'controller'	=>	'documents',
		'action'		=>	'serve',
		'file'			=>	base64_encode($direct_link),
	);
	echo $this->Html->link($name, $internal_link, array('escape' => false, 'class' => 'file-link', 'direct' => true, 'target' => '_blank'));
	?>
</div>
<div class="file-actions btn-group col-lg-6">
	<!-- <a href="#" class="view-extra btn btn-default"><?php echo __d("document_manager", "Détails");?></a> -->
...
<?php if (@$file['writeable']): ?>
	<?php echo $this->Html->link(
		...
		array(
			'class' => 'btn btn-default ajax-rename',
			'filename' => $file['name'],
